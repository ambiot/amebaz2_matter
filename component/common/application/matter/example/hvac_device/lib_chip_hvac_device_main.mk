...
INCLUDES += -I$(SDKROOTDIR)/component/common/application/matter/example/hvac_device
...
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/driver/thermostat_driver.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/driver/thermostat_ui_driver.cpp
...
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/hvac_device/example_matter_hvac_device.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/hvac_device/matter_drivers.cpp
