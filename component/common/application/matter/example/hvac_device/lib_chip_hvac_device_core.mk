...
GENERATE_NINJA:
	...
	cd $(CHIPDIR)/config/ameba/components/chip && gn gen --check --fail-on-unused-args $(BASEDIR)/build/chip && \
	cd $(CHIPDIR)/config/ameba/components/chip ; ninja -C $(BASEDIR)/build/chip :ameba && \
